...
exports.getPaginationUrl = exports.safeGet = exports.hasOwnProperties = exports.apiRequest = exports.jsonContentTypes = undefined;
...
var safeGet = exports.safeGet = function safeGet(obj, path, defaultVal) {
  var curObj = obj;
...
var getPaginationUrl = exports.getPaginationUrl = function getPaginationUrl(response, direction, path) {
  var paginationUrl = safeGet(response, ['links', direction], null);
  if (!paginationUrl) {
    return null;
  }
